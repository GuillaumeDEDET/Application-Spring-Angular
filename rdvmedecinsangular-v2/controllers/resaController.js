/**
 * Created by GuillaumeD on 26/04/2016.
 */
angular.module("rdvmedecins")
    .controller('resaCtrl', ['$scope', "config", "$filter", "$translate", "$locate", "$location", "utils", "dao",
        function ($scope, config, $filter, $translate, $locate, $location, utils, dao) {
            ...
            var navigationAllowed = lastView.url == config.urlResa || (lastView.url == config.urlAgenda && lastView.done);
